...
1. **Body mass ~101 kg** (101.15 kg latest reading, Sep 2026 — down from ~103 kg in June; only 2 Withings readings in the last 6 weeks, so treat the exact trend as thin data, not a reversal). Metabolic heat production and heat storage scale with mass; a big athlete's core temperature rises faster for the same pace. More mass, less surface-area-to-mass ratio to dump heat.
